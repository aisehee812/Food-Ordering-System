    ...
    Elogin() {
        ...
        b1.addActionListener(
                a->
                {
                    ...
                    try (Connection con = DriverManager.getConnection(url, "root", "harshal18"))
                    {
        ...
        b2.addActionListener(
                e -> {
                    // Example: Go back to the previous screen or close this window
                    dispose(); // Closes the current login window
                    new Landing(); // Replace this with your actual previous screen class
                }
        );
